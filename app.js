...
(function(){
  ...
  const servicesData = {
    "ai-software": {
      ...
      cards: [
        { title: "AI Agents & Chatbots", description: "Build intelligent assistants that answer questions, automate tasks, and improve customer or team interaction.", image: "images/services/01-ai-solutions.jpg" },
        { title: "Automation Systems", description: "Automate repetitive workflows, connect systems, and reduce manual effort across daily operations.", image: "images/services/03-automations.jpg" },
        { title: "Data & BI Solutions", description: "Turn raw data into clear dashboards, reports, and insights that support better decision-making.", image: "images/services/05-business-intelligence.jpg" },
        { title: "Smart Applications", description: "Develop custom applications powered by AI and modern technologies to support real business needs.", image: "images/services/02-applications-ai.jpg" }
      ]
    },
    "training-center": {
      ...
      cards: [
        { title: "Customized Training Programs", description: "Training tailored to your organization, team level, and specific business needs.", image: "images/services/02-applications-ai.jpg" },
        { title: "Tools & Software Training", description: "We train your team on the tools you need — whether by helping you choose the right solution or delivering training on specific software requested by your organization.", image: "images/services/04-interactive-web.jpg" },
        { title: "Organization & Team Training", description: "Training programs designed for companies, government entities, schools, and universities.", image: "images/services/01-ai-solutions.jpg" },
        { title: "Practical AI Usage", description: "Learn how to use AI in real work scenarios to improve workflows, productivity, and decision-making.", image: "images/services/03-automations.jpg" }
      ]
    },
    hardware: {
